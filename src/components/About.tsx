  ...
  return (
   <>
     <div className='flex flex-col md:flex-row  pt-20 pb-10 pr-2'>
        <div className='flex flex-col gap-3 ml-8 md:ml-20 pr-2  md:pr-0 items-center md:items-start'>
           ...
           <p className='font-josefin text-justify text-blackish w-[95%] text-lg md:w-[80%] pb-4'>
             We're a family-owned Mediterranean Restaurant focused on traditional recipes served with a modern twist. Indulge in a culinary journey that captures the essence of our family's heritage, where every bite is a celebration of tradition and innovation.
