  ...
  return (
    <main className=" max-w-xxl 2xl:max-w-xxxl mx-auto">
      ...
      <div className="flex justify-center  lg:h-4/5 m-5 pb-10">
        <form
          className="w-10/12 lg:w-8/12 bg-greener rounded-2xl font-josefin flex flex-col items-center px-4 md:pl-3 py-8 md:py-16"
          onSubmit={handleForm}
        >
          {/*Date*/}
          ...
          <div className="sm:grid grid-cols-2 gap-x-10 gap-y-4 pb-2 pr-2 ">
            <div className="mb-4  md:w-full ">
              ...
              <input
                id="date"
                type="date"
                className="input input-bordered w-[100%] md:w-64 "
          ...
          <div className="mb-4 w-[85%] md:w-auto grid ">
            ...
            <textarea
              id="occasion"
              className="textarea textarea-bordered  sm:w-96 lg:w-zz"
          ...
          <div className=" self-center mt-4 ">
            <button
              className="bg-golden hover:bg-greener text-white hover:border font-bold py-2 px-4 rounded w-32 md:w-44"
              type="button"
            >
              Book ❯
            </button>
